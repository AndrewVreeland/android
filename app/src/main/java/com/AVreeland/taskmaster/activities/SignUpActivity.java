...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void setUpSignUpButton() {
        Button signUpButton = findViewById(R.id.signupActicitySignupButton);

        signUpButton.setOnClickListener(v -> {
            String userEmail = ((EditText) findViewById(R.id.signupActivityEmailEditText2)).getText().toString();
